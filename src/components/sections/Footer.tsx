      ...
      <div className="container-layout">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-4 flex flex-col">
            <Link
              href="/"
              className="flex items-center gap-3 mb-6 w-max p-2 -ml-2"
            >
            ...
            <p className="text-white/60 max-w-sm mb-8 leading-relaxed">
              We mint ideas into powerful stories. A creative experience company
          ...
          <div className="lg:col-span-2 lg:col-start-6">
            <h4 className="text-sm font-bold tracking-widest text-white/40 uppercase mb-6">
              Studio
            </h4>
            <ul className="flex flex-col gap-4">
              <li>
                <Link
                  href={isHome ? "#manifesto" : "/#manifesto"}
                  className="hover:text-creative-flame transition-colors font-medium p-2 -ml-2 w-max inline-block"
                >
                  About Us
                </Link>
              </li>
              ...
              <li>
                <Link
                  href="#"
                  className="hover:text-creative-flame transition-colors font-medium flex items-center gap-1 p-2 -ml-2 w-max"
                >
                  Careers{" "}
                  <svg
                    className="w-3 h-3"
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-sm text-white/60 mb-4">
              Subscribe to our newsletter for brand strategy insights and studio
              updates.
            </p>
            <form
            ...
            >
              <div className="relative">
                ...
                <button
                  type="submit"
                  className="absolute right-1 top-1 bottom-1 px-4 bg-white text-section-ink rounded-full text-xs font-bold hover:bg-creative-flame hover:text-white transition-colors min-w-[80px]"
                >
                  Join
                </button>
              </div>
